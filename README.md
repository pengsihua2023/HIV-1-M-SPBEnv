...
**Figure 2.** Marked in green are the 5 synthesized L samples clustered together with the L samples in the gold standard (in red), showing that the synthetic samples are potential L samples.    
