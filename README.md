...
````
## 7. Model architecture of HIV-1-M-SPBEnv deep learning classifier  
...
## 8. Genetic operations for generating new env gene sequence samples
...
## 9　How can I prove that our synthetic samples are reliable? 　　
...
### 13.4 The independent evaluation dataset
