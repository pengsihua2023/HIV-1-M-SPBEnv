...
Using an independent validation dataset, the accuracy of HIV-1-M-SPBEnv reached 100%, demonstrating strong model generalization capabilities. The trained model is deployed at [https://www.hivsubclass.com/](https://www.hivsubclass.com/introduction).    
## 1. Requirements
Python == 3.10.13    
torch == 2.1.0+cu121  
