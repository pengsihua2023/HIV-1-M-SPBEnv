...
In our deep learning model framework, I use the Kmer method to vectorize DNA sequences; I use a three-layer dilated convolution module to initially extract features of the DNA sequence. Then, I use an Autoencoder to further extract high-dimensional feature information of the env gene sequence, supplemented by an Self Attention mechanism to extract features from the encoder output, and finally, I use a three-layer fully connected layer to classify the 12 subtypes. For the complete model architecture and main parameters, please see Figure1.
