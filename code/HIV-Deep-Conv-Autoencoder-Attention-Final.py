...
# Converting k-mer to index of feature vector
...
class DeepModel(nn.Module):                                    
    def __init__(self, input_dim, num_classes, ae_hidden_dim):
        ...
        self.attention = SelfAttention(embed_size=ae_hidden_dim // 8, heads=8)  # Pay attention to adjusting embed_size
        self.fc1 = nn.Linear(ae_hidden_dim, 256)
...
# Save model
model_path = 'HIV-Deep-Conv-Autoencoder-Attention-1.pth'
